<?php
  if(isset($_SESSION['account']["userId"])) {
    ...
    $userId = ($_SESSION['account']["userId"]); } ?> 
            ...
            <form class="share__form" action="/post" method="post">
          ...
          <post class="post">
            <div class="post__header">
              ...
              <div class="post__buttons">
                <a class="post__btn fa fa-edit" href="/edit/<?php echo $data['postId'];?>">Регадувати</a>
                <a class="post__btn fa fa-trash" href="/delete/<?php echo $data['postId'];?>">Видалити</a>
              </div>
              <br>
          </post>
          <border class="border">
